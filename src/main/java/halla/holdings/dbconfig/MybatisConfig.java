package halla.holdings.dbconfig;//package com.holdings.config;
//
...
//
//@Configuration
//@MapperScan(basePackages = "com.holdings.*.*")
//class MybatisConfig {
//
//    @Bean
...
//
//@Configuration
//@MapperScan(value = "halla.holdings.", sqlSessionFactoryRef = "db1SqlSessionFactory")
