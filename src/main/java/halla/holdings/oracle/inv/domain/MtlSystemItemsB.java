...
public class MtlSystemItemsB implements Serializable {
    ...
    private double last_update_login;
    @Column(name = "SUMMARY_FLAG")
    private String summary_flag;
    @Column(name = "ENABLED_FLAG")
    private String enabled_flag;
    @Column(name = "START_DATE_ACTIVE")
    private LocalDateTime start_date_active;
    @Column(name = "END_DATE_ACTIVE")
    private LocalDateTime end_date_active;
    @Column(name = "DESCRIPTION")
    private String description;
    @Column(name = "BUYER_ID")
    private double buyer_id;
    @Column(name = "ACCOUNTING_RULE_ID")
    private double accounting_rule_id;
    @Column(name = "INVOICING_RULE_ID")
    private double invoicing_rule_id;
    ...
    private String purchasing_item_flag;
    @Column(name = "SHIPPABLE_ITEM_FLAG")
    private String shippable_item_flag;
    @Column(name = "CUSTOMER_ORDER_FLAG")
    private String customer_order_flag;
    @Column(name = "INTERNAL_ORDER_FLAG")
    private String internal_order_flag;
    @Column(name = "SERVICE_ITEM_FLAG")
    private String service_item_flag;
    @Column(name = "INVENTORY_ITEM_FLAG")
    private String inventory_item_flag;
    @Column(name = "ENG_ITEM_FLAG")
    private String eng_item_flag;
    @Column(name = "INVENTORY_ASSET_FLAG")
    private String inventory_asset_flag;
    @Column(name = "PURCHASING_ENABLED_FLAG")
    private String purchasing_enabled_flag;
    @Column(name = "CUSTOMER_ORDER_ENABLED_FLAG")
    private String customer_order_enabled_flag;
    @Column(name = "INTERNAL_ORDER_ENABLED_FLAG")
    private String internal_order_enabled_flag;
    @Column(name = "SO_TRANSACTIONS_FLAG")
    private String so_transactions_flag;
    @Column(name = "MTL_TRANSACTIONS_ENABLED_FLAG")
    private String mtl_transactions_enabled_flag;
    @Column(name = "STOCK_ENABLED_FLAG")
    private String stock_enabled_flag;
    @Column(name = "BOM_ENABLED_FLAG")
    private String bom_enabled_flag;
    @Column(name = "BUILD_IN_WIP_FLAG")
    private String build_in_wip_flag;
    @Column(name = "REVISION_QTY_CONTROL_CODE")
    private double revision_qty_control_code;
    @Column(name = "ITEM_CATALOG_GROUP_ID")
    private double item_catalog_group_id;
    @Column(name = "CATALOG_STATUS_FLAG")
    private String catalog_status_flag;
    @Column(name = "RETURNABLE_FLAG")
    private String returnable_flag;
    @Column(name = "DEFAULT_SHIPPING_ORG")
    private double default_shipping_org;
    ...
    private String enforce_ship_to_location_code;
    @Column(name = "ALLOW_SUBSTITUTE_RECEIPTS_FLAG")
    private String allow_substitute_receipts_flag;
    @Column(name = "ALLOW_UNORDERED_RECEIPTS_FLAG")
    private String allow_unordered_receipts_flag;
    @Column(name = "ALLOW_EXPRESS_DELIVERY_FLAG")
    private String allow_express_delivery_flag;
    @Column(name = "DAYS_EARLY_RECEIPT_ALLOWED")
    private double days_early_receipt_allowed;
    @Column(name = "DAYS_LATE_RECEIPT_ALLOWED")
    private double days_late_receipt_allowed;
    @Column(name = "RECEIPT_DAYS_EXCEPTION_CODE")
    private String receipt_days_exception_code;
    @Column(name = "RECEIVING_ROUTING_ID")
    private double receiving_routing_id;
    @Column(name = "INVOICE_CLOSE_TOLERANCE")
    private double invoice_close_tolerance;
    @Column(name = "RECEIVE_CLOSE_TOLERANCE")
    private double receive_close_tolerance;
    @Column(name = "AUTO_LOT_ALPHA_PREFIX")
    private String auto_lot_alpha_prefix;
    @Column(name = "START_AUTO_LOT_NUMBER")
    private String start_auto_lot_number;
    @Column(name = "LOT_CONTROL_CODE")
    private double lot_control_code;
    @Column(name = "SHELF_LIFE_CODE")
    private double shelf_life_code;
    @Column(name = "SHELF_LIFE_DAYS")
    private double shelf_life_days;
    @Column(name = "SERIAL_NUMBER_CONTROL_CODE")
    private double serial_number_control_code;
    @Column(name = "START_AUTO_SERIAL_NUMBER")
    private String start_auto_serial_number;
    @Column(name = "AUTO_SERIAL_ALPHA_PREFIX")
    private String auto_serial_alpha_prefix;
    @Column(name = "SOURCE_TYPE")
    private double source_type;
    @Column(name = "SOURCE_ORGANIZATION_ID")
    private double source_organization_id;
    @Column(name = "SOURCE_SUBINVENTORY")
    private String source_subinventory;
    @Column(name = "EXPENSE_ACCOUNT")
    private double expense_account;
    @Column(name = "ENCUMBRANCE_ACCOUNT")
    private double encumbrance_account;
    @Column(name = "RESTRICT_SUBINVENTORIES_CODE")
    private double restrict_subinventories_code;
    @Column(name = "UNIT_WEIGHT")
    private double unit_weight;
    @Column(name = "WEIGHT_UOM_CODE")
    private String weight_uom_code;
    @Column(name = "VOLUME_UOM_CODE")
    private String volume_uom_code;
    @Column(name = "UNIT_VOLUME")
    private double unit_volume;
    @Column(name = "RESTRICT_LOCATORS_CODE")
    private double restrict_locators_code;
    @Column(name = "LOCATION_CONTROL_CODE")
    private double location_control_code;
    @Column(name = "SHRINKAGE_RATE")
    private double shrinkage_rate;
    @Column(name = "ACCEPTABLE_EARLY_DAYS")
    private double acceptable_early_days;
    @Column(name = "PLANNING_TIME_FENCE_CODE")
    private double planning_time_fence_code;
    @Column(name = "DEMAND_TIME_FENCE_CODE")
    private double demand_time_fence_code;
    @Column(name = "LEAD_TIME_LOT_SIZE")
    private double lead_time_lot_size;
    @Column(name = "STD_LOT_SIZE")
    private double std_lot_size;
    @Column(name = "CUM_MANUFACTURING_LEAD_TIME")
    private double cum_manufacturing_lead_time;
    @Column(name = "OVERRUN_PERCENTAGE")
    private double overrun_percentage;
    @Column(name = "MRP_CALCULATE_ATP_FLAG")
    private String mrp_calculate_atp_flag;
    @Column(name = "ACCEPTABLE_RATE_INCREASE")
    private double acceptable_rate_increase;
    @Column(name = "ACCEPTABLE_RATE_DECREASE")
    private double acceptable_rate_decrease;
    @Column(name = "CUMULATIVE_TOTAL_LEAD_TIME")
    private double cumulative_total_lead_time;
    @Column(name = "PLANNING_TIME_FENCE_DAYS")
    private double planning_time_fence_days;
    @Column(name = "DEMAND_TIME_FENCE_DAYS")
    private double demand_time_fence_days;
    @Column(name = "END_ASSEMBLY_PEGGING_FLAG")
    private String end_assembly_pegging_flag;
    @Column(name = "REPETITIVE_PLANNING_FLAG")
    private String repetitive_planning_flag;
    @Column(name = "PLANNING_EXCEPTION_SET")
    private String planning_exception_set;
    @Column(name = "BOM_ITEM_TYPE")
    private double bom_item_type;
    @Column(name = "PICK_COMPONENTS_FLAG")
    private String pick_components_flag;
    @Column(name = "REPLENISH_TO_ORDER_FLAG")
    private String replenish_to_order_flag;
    @Column(name = "BASE_ITEM_ID")
    private double base_item_id;
    @Column(name = "ATP_COMPONENTS_FLAG")
    private String atp_components_flag;
    @Column(name = "ATP_FLAG")
    private String atp_flag;
    @Column(name = "FIXED_LEAD_TIME")
    private double fixed_lead_time;
    @Column(name = "VARIABLE_LEAD_TIME")
    private double variable_lead_time;
    @Column(name = "WIP_SUPPLY_LOCATOR_ID")
    private double wip_supply_locator_id;
    @Column(name = "WIP_SUPPLY_TYPE")
    private double wip_supply_type;
    @Column(name = "WIP_SUPPLY_SUBINVENTORY")
    private String wip_supply_subinventory;
    ...
    private String purchasing_tax_code;
    @Column(name = "OVERCOMPLETION_TOLERANCE_TYPE")
    private double overcompletion_tolerance_type;
    @Column(name = "OVERCOMPLETION_TOLERANCE_VALUE")
    private double overcompletion_tolerance_value;
    @Column(name = "EFFECTIVITY_CONTROL")
    private double effectivity_control;
    @Column(name = "CHECK_SHORTAGES_FLAG")
    private String check_shortages_flag;
    @Column(name = "OVER_SHIPMENT_TOLERANCE")
    private double over_shipment_tolerance;
    @Column(name = "UNDER_SHIPMENT_TOLERANCE")
    private double under_shipment_tolerance;
    @Column(name = "OVER_RETURN_TOLERANCE")
    private double over_return_tolerance;
    @Column(name = "UNDER_RETURN_TOLERANCE")
    private double under_return_tolerance;
    @Column(name = "EQUIPMENT_TYPE")
    private double equipment_type;
    @Column(name = "RECOVERED_PART_DISP_CODE")
    private String recovered_part_disp_code;
    @Column(name = "DEFECT_TRACKING_ON_FLAG")
    private String defect_tracking_on_flag;
    @Column(name = "USAGE_ITEM_FLAG")
    private String usage_item_flag;
    @Column(name = "EVENT_FLAG")
    private String event_flag;
    @Column(name = "ELECTRONIC_FLAG")
    private String electronic_flag;
    @Column(name = "DOWNLOADABLE_FLAG")
    private String downloadable_flag;
    @Column(name = "VOL_DISCOUNT_EXEMPT_FLAG")
    private String vol_discount_exempt_flag;
    @Column(name = "COUPON_EXEMPT_FLAG")
    private String coupon_exempt_flag;
    @Column(name = "COMMS_NL_TRACKABLE_FLAG")
    private String comms_nl_trackable_flag;
    @Column(name = "ASSET_CREATION_CODE")
    private String asset_creation_code;
    @Column(name = "COMMS_ACTIVATION_REQD_FLAG")
    private String comms_activation_reqd_flag;
    @Column(name = "ORDERABLE_ON_WEB_FLAG")
    private String orderable_on_web_flag;
    @Column(name = "BACK_ORDERABLE_FLAG")
    private String back_orderable_flag;
    @Column(name = "WEB_STATUS")
    private String web_status;
    @Column(name = "INDIVISIBLE_FLAG")
    private String indivisible_flag;
    @Column(name = "DIMENSION_UOM_CODE")
    private String dimension_uom_code;
    ...
    private String bulk_picked_flag;
    @Column(name = "LOT_STATUS_ENABLED")
    private String lot_status_enabled;
    @Column(name = "DEFAULT_LOT_STATUS_ID")
    private double default_lot_status_id;
    @Column(name = "SERIAL_STATUS_ENABLED")
    private String serial_status_enabled;
    @Column(name = "DEFAULT_SERIAL_STATUS_ID")
    private double default_serial_status_id;
    @Column(name = "LOT_SPLIT_ENABLED")
    private String lot_split_enabled;
    @Column(name = "LOT_MERGE_ENABLED")
    private String lot_merge_enabled;
    @Column(name = "INVENTORY_CARRY_PENALTY")
    private double inventory_carry_penalty;
    @Column(name = "OPERATION_SLACK_PENALTY")
    private double operation_slack_penalty;
    @Column(name = "FINANCING_ALLOWED_FLAG")
    private String financing_allowed_flag;
    @Column(name = "EAM_ITEM_TYPE")
    private double eam_item_type;
    @Column(name = "EAM_ACTIVITY_TYPE_CODE")
    private String eam_activity_type_code;
    @Column(name = "EAM_ACTIVITY_CAUSE_CODE")
    private String eam_activity_cause_code;
    @Column(name = "EAM_ACT_NOTIFICATION_FLAG")
    private String eam_act_notification_flag;
    @Column(name = "EAM_ACT_SHUTDOWN_STATUS")
    private String eam_act_shutdown_status;
    @Column(name = "DUAL_UOM_CONTROL")
    private double dual_uom_control;
    @Column(name = "SECONDARY_UOM_CODE")
    private String secondary_uom_code;
    @Column(name = "DUAL_UOM_DEVIATION_HIGH")
    private double dual_uom_deviation_high;
    @Column(name = "DUAL_UOM_DEVIATION_LOW")
    private double dual_uom_deviation_low;
    @Column(name = "CONTRACT_ITEM_TYPE_CODE")
    private String contract_item_type_code;
    @Column(name = "SUBSCRIPTION_DEPEND_FLAG")
    private String subscription_depend_flag;
    @Column(name = "SERV_REQ_ENABLED_CODE")
    private String serv_req_enabled_code;
    @Column(name = "SERV_BILLING_ENABLED_FLAG")
    private String serv_billing_enabled_flag;
    @Column(name = "SERV_IMPORTANCE_LEVEL")
    private double serv_importance_level;
    @Column(name = "PLANNED_INV_POINT_FLAG")
    private String planned_inv_point_flag;
    @Column(name = "LOT_TRANSLATE_ENABLED")
    private String lot_translate_enabled;
    @Column(name = "DEFAULT_SO_SOURCE_TYPE")
    private String default_so_source_type;
    @Column(name = "CREATE_SUPPLY_FLAG")
    private String create_supply_flag;
    @Column(name = "SUBSTITUTION_WINDOW_CODE")
    private double substitution_window_code;
    @Column(name = "SUBSTITUTION_WINDOW_DAYS")
    private double substitution_window_days;
    @Column(name = "IB_ITEM_INSTANCE_CLASS")
    private String ib_item_instance_class;
    @Column(name = "CONFIG_MODEL_TYPE")
    private String config_model_type;
    @Column(name = "LOT_SUBSTITUTION_ENABLED")
    private String lot_substitution_enabled;
    @Column(name = "MINIMUM_LICENSE_QUANTITY")
    private double minimum_license_quantity;
    @Column(name = "EAM_ACTIVITY_SOURCE_CODE")
    private String eam_activity_source_code;
    @Column(name = "LIFECYCLE_ID")
    private double lifecycle_id;
    @Column(name = "CURRENT_PHASE_ID")
    private double current_phase_id;
    @Column(name = "OBJECT_VERSION_NUMBER")
    private double object_version_number;
    @Column(name = "TRACKING_QUANTITY_IND")
    private String tracking_quantity_ind;
    @Column(name = "ONT_PRICING_QTY_SOURCE")
    private String ont_pricing_qty_source;
    @Column(name = "SECONDARY_DEFAULT_IND")
    private String secondary_default_ind;
    @Column(name = "OPTION_SPECIFIC_SOURCED")
    private double option_specific_sourced;
    @Column(name = "APPROVAL_STATUS")
    private String approval_status;
    @Column(name = "VMI_MINIMUM_UNITS")
    private double vmi_minimum_units;
    @Column(name = "VMI_MINIMUM_DAYS")
    private double vmi_minimum_days;
    @Column(name = "VMI_MAXIMUM_UNITS")
    private double vmi_maximum_units;
    @Column(name = "VMI_MAXIMUM_DAYS")
    private double vmi_maximum_days;
    @Column(name = "VMI_FIXED_ORDER_QUANTITY")
    private double vmi_fixed_order_quantity;
    @Column(name = "SO_AUTHORIZATION_FLAG")
    private double so_authorization_flag;
    @Column(name = "CONSIGNED_FLAG")
    private double consigned_flag;
    @Column(name = "ASN_AUTOEXPIRE_FLAG")
    private double asn_autoexpire_flag;
    @Column(name = "VMI_FORECAST_TYPE")
    private double vmi_forecast_type;
    @Column(name = "FORECAST_HORIZON")
    private double forecast_horizon;
    @Column(name = "EXCLUDE_FROM_BUDGET_FLAG")
    private double exclude_from_budget_flag;
    @Column(name = "DAYS_TGT_INV_SUPPLY")
    private double days_tgt_inv_supply;
    @Column(name = "DAYS_TGT_INV_WINDOW")
    private double days_tgt_inv_window;
    @Column(name = "DAYS_MAX_INV_SUPPLY")
    private double days_max_inv_supply;
    @Column(name = "DAYS_MAX_INV_WINDOW")
    private double days_max_inv_window;
    @Column(name = "DRP_PLANNED_FLAG")
    private double drp_planned_flag;
    @Column(name = "CRITICAL_COMPONENT_FLAG")
    private double critical_component_flag;
    @Column(name = "CONTINOUS_TRANSFER")
    private double continous_transfer;
    @Column(name = "CONVERGENCE")
    private double convergence;
    @Column(name = "DIVERGENCE")
    private double divergence;
    @Column(name = "CONFIG_ORGS")
    private String config_orgs;
    @Column(name = "CONFIG_MATCH")
    private String config_match;
