...
@IdClass(MtlSystemItemsInterface.class)
@Data
public class MtlSystemItemsInterface implements Serializable {
    ...
    @Column(name = "MUST_USE_APPROVED_VENDOR_FLAG")
    ...
    @Column(name = "OUTSIDE_OPERATION_FLAG")
    ...
    @Column(name = "DEMAND_SOURCE_LINE")
    ...
    @Column(name = "AUTO_CREATED_CONFIG_FLAG")
    ...
    @Column(name = "DEMAND_SOURCE_TYPE")
    private String demandSourceType;

    @Column(name = "DEMAND_SOURCE_HEADER_ID")
    private String demandSourceHeaderId;
    ...
    @Column(name = "COPY_ORGANIZATION_ID")
    private String copyOrganizationId;

    @Column(name = "COPY_ORGANIZATION_CODE")
    ...
    @Column(name = "MATERIAL_SUB_ELEM")
    private String materialSubElem;

    @Column(name = "MATERIAL_OH_RATE")
    private String materialOhRate;

    @Column(name = "MATERIAL_OH_SUB_ELEM")
    private String materialOhSubElem;

    @Column(name = "MATERIAL_SUB_ELEM_ID")
    private String materialSubElemId;

    @Column(name = "MATERIAL_OH_SUB_ELEM_ID")
    private String materialOhSubElemId;
    ...
    @Column(name = "SET_PROCESS_ID", nullable = false)
    private String setProcessId = "0";
