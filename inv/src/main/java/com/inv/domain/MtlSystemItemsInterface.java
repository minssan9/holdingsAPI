...
public class MtlSystemItemsInterface implements Serializable {
    ...
    private LocalDateTime engineeringDate;
    ...
    private long setProcessId=0;
    @Column(name = "WH_UPDATE_DATE")
    private LocalDateTime whUpdateDate;
    ...
    public MtlSystemItemsInterface(XxeItemsImportTemp xxeItemsImportTemp) {
        this.organizationId = xxeItemsImportTemp.getOrganizationId();
        this.segment1 = xxeItemsImportTemp.getSegment1();
        this.description = xxeItemsImportTemp.getDescription();
        this.primaryUomCode = xxeItemsImportTemp.getPrimaryUomCode();
        this.templateName = xxeItemsImportTemp.getTemplateName();
        this.engItemFlag = xxeItemsImportTemp.getEngItemFlag();
        this.weightUomCode = xxeItemsImportTemp.getWeightUomCode();
        this.unitWeight = xxeItemsImportTemp.getUnitWeight();
        this.volumeUomCode = xxeItemsImportTemp.getVolumeUomCode();
        this.unitVolume = xxeItemsImportTemp.getUnitVolume();
        this.attribute1 = xxeItemsImportTemp.getAttribute1();
        this.attribute2 = xxeItemsImportTemp.getAttribute2();
        this.attribute3 = xxeItemsImportTemp.getAttribute3();
        this.attribute4 = xxeItemsImportTemp.getAttribute4();
        this.attribute5 = xxeItemsImportTemp.getAttribute5();
        this.attribute6 = xxeItemsImportTemp.getAttribute6();
        this.attribute7 = xxeItemsImportTemp.getAttribute7();
        this.attribute8 = xxeItemsImportTemp.getAttribute8();
        this.attribute9 = xxeItemsImportTemp.getAttribute9();
        this.attribute10 = xxeItemsImportTemp.getAttribute10();
        this.attribute11 = xxeItemsImportTemp.getAttribute11();
        this.attribute12 = xxeItemsImportTemp.getAttribute12();
        this.attribute13 = xxeItemsImportTemp.getAttribute13();
        this.attribute14 = xxeItemsImportTemp.getAttribute14();
        this.attribute15 = xxeItemsImportTemp.getAttribute15();
        this.globalAttribute1 = xxeItemsImportTemp.getGlobalAttribute1();
        this.globalAttribute2 = xxeItemsImportTemp.getGlobalAttribute2();
        this.globalAttribute3 = xxeItemsImportTemp.getGlobalAttribute3();
        this.transactionType = xxeItemsImportTemp.getTransactionType();
        this.processFlag = xxeItemsImportTemp.getProcessFlag();
        this.setProcessId = xxeItemsImportTemp.getSetProcessId();
    }

    public MtlSystemItemsInterface(XSSFRow row) {
