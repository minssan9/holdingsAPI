...
public class XxeInvMonthlyReceipts {
    ...
    public boolean equals(Object o) {
        ...
        if (receiptTransactionId != that.receiptTransactionId) {
            return false;
        }
        ...
        if (receiptsNumber != null ? !receiptsNumber.equals(that.receiptsNumber)
            : that.receiptsNumber != null) {
            return false;
        }
        if (sourceDocumentNumber != null ? !sourceDocumentNumber.equals(that.sourceDocumentNumber)
            : that.sourceDocumentNumber != null) {
            return false;
        }
        if (shipmentLineId != null ? !shipmentLineId.equals(that.shipmentLineId)
            : that.shipmentLineId != null) {
            return false;
        }
        ...
        if (sourceDocumentCode != null ? !sourceDocumentCode.equals(that.sourceDocumentCode)
            : that.sourceDocumentCode != null) {
            return false;
        }
