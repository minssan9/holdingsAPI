...
@IdClass(XxeInvMonthlyIssues.class)
public class XxeInvMonthlyIssues implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (issueTransactionId != that.issueTransactionId) {
            return false;
        }
        ...
        if (invoiceDate != null ? !invoiceDate.equals(that.invoiceDate)
            : that.invoiceDate != null) {
            return false;
        }
        ...
        if (mmtTransactionId != null ? !mmtTransactionId.equals(that.mmtTransactionId)
            : that.mmtTransactionId != null) {
            return false;
        }
        ...
        if (transactionQuantity != null ? !transactionQuantity.equals(that.transactionQuantity)
            : that.transactionQuantity != null) {
            return false;
        }
        ...
        if (transactionAmount != null ? !transactionAmount.equals(that.transactionAmount)
            : that.transactionAmount != null) {
            return false;
        }
        if (closeAmount != null ? !closeAmount.equals(that.closeAmount)
            : that.closeAmount != null) {
            return false;
        }
        if (issueCode != null ? !issueCode.equals(that.issueCode) : that.issueCode != null) {
            return false;
        }
        if (noIssueTag != null ? !noIssueTag.equals(that.noIssueTag) : that.noIssueTag != null) {
            return false;
        }
        if (codeSegment1 != null ? !codeSegment1.equals(that.codeSegment1)
            : that.codeSegment1 != null) {
            return false;
        }
        if (codeSegment2 != null ? !codeSegment2.equals(that.codeSegment2)
            : that.codeSegment2 != null) {
            return false;
        }
        if (codeSourceType3 != null ? !codeSourceType3.equals(that.codeSourceType3)
            : that.codeSourceType3 != null) {
            return false;
        }
        if (codeSource3 != null ? !codeSource3.equals(that.codeSource3)
            : that.codeSource3 != null) {
            return false;
        }
        if (codeSegment3 != null ? !codeSegment3.equals(that.codeSegment3)
            : that.codeSegment3 != null) {
            return false;
        }
        if (codeSourceType4 != null ? !codeSourceType4.equals(that.codeSourceType4)
            : that.codeSourceType4 != null) {
            return false;
        }
        if (codeSource4 != null ? !codeSource4.equals(that.codeSource4)
            : that.codeSource4 != null) {
            return false;
        }
        if (codeSegment4 != null ? !codeSegment4.equals(that.codeSegment4)
            : that.codeSegment4 != null) {
            return false;
        }
        if (codeSourceType5 != null ? !codeSourceType5.equals(that.codeSourceType5)
            : that.codeSourceType5 != null) {
            return false;
        }
        if (codeSource5 != null ? !codeSource5.equals(that.codeSource5)
            : that.codeSource5 != null) {
            return false;
        }
        if (codeSegment5 != null ? !codeSegment5.equals(that.codeSegment5)
            : that.codeSegment5 != null) {
            return false;
        }
        if (creationSourceCode != null ? !creationSourceCode.equals(that.creationSourceCode)
            : that.creationSourceCode != null) {
            return false;
        }
