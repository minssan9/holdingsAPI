...
public class XxeItemCategoriesTemp {
    ...
    @Column(name = "INVENTORY_ITEM_ID") private Long inventoryItemId;
    @Column(name = "CATEGORY_SET_NAME") private String categorySetName;
    @Column(name = "CATEGORY_SET_ID") private Long categorySetId;
